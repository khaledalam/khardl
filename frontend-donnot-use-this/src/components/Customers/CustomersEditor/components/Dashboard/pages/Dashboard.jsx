   ...
   return (
      ...
      style={{maxWidth:`${divWidth}px`}}>
         ...
         <div className="p-8 bg-white">
            <div className={`grid grid-cols-3 gap-4 mb-4 ${divWidth <= 550 ? "grid-cols-1" : ""}`}>
               <StatsCard title={t("Wallet")} Stats="700" />
               <StatsCard title={t("Loyalty Point")} Stats="500" ShowIcons={true} />
               <StatsCard title={t("Total Cash Back")} Stats="1500" ShowIcons={true} IsUp={true} />
            </div>
            <LastOrders />
