...
const Toolbar = ({ selectedText, selectedShape, buttonId, lastButton, selectedColor }) => {
                ...
                <div className='flex justify-between items-center gap-4 w-[180px]'>
                    ...
                    <input
                        ...
                        onChange={e => {
                            ...
                            handleButonChange(buttonId, e.target.value, GlobalColor, editedShape);
                        }}
                    />
                </div>
                <div className='flex justify-between items-center gap-2 w-[180px]'>
                    ...
                    <input
                        ...
                        onChange={e => {
                            ...
                            handleButonChange(buttonId, editedText, e.target.value, editedShape);
                        }}
                    />
                </div>
                <div className='flex justify-center items-center gap-2'>
                    <button value="0px" onClick={(e) => { setEditedShape("0px"); handleButonChange(buttonId, editedText, GlobalColor, e.target.value); }}
                        className={`bg-[var(--secondary)] p-1 border-[var(--third)]  border-[2px] w-10 h-6`}
                        style={editedShape === "0px" ? { backgroundColor: GlobalColor, border: `2px solid ${GlobalColor}` } : {}}>
                    </button>
                    <button value="8px" onClick={(e) => { setEditedShape("8px"); handleButonChange(buttonId, editedText, GlobalColor, e.target.value); }}
                        className={`bg-[var(--secondary)] p-1 rounded-[8px] border-[var(--third)]  border-[2px] w-10 h-6`}
                        style={editedShape === "8px" ? { backgroundColor: GlobalColor, border: `2px solid ${GlobalColor}` } : {}}>
                    </button>
                    <button value="20px" onClick={(e) => { setEditedShape("20px"); handleButonChange(buttonId, editedText, GlobalColor, e.target.value); }}
                        className={`bg-[var(--secondary)] p-1 rounded-full border-[var(--third)]  border-[2px] w-10 h-6`}
                        style={editedShape === "20px" ? { backgroundColor: GlobalColor, border: `2px solid ${GlobalColor}` } : {}}>
                    </button>
                </div>
            </div>
        </div>
