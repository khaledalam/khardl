                    ...
                    <div className="py-[80px] max-md:py-[60px]">
                        <div className="max-[860px]:w-[80vw] w-[450px] bg-white py-10 max-[860px]:px-2 shadow-lg rounded-2xl">
                            <div className='px-8 mb-4 flex flex-col items-center text-center'>
                                ...
                                <h3 className="pt-6 text-md font-bold">{t("New Password")}</h3>
                            </div>
                            <form onSubmit={handleSubmit(onSubmit)} className="px-8 pb-2 bg-white rounded">
                                <div className="mb-6 text-center">
                                    <div className="mb-4 text-center">
                                        <label className="block mb-2 text-sm text-start font-bold text-gray-700" htmlFor="email">
                                        ...
                                        />
                                        {errors.token && <span className='text-red-500 text-xs mt-1 ms-2'>{t("Validation code Error")}</span>}
                                    </div>

                                    {/* Input 3 */}
                                    <div className='relative'>
                                        <h4 className='mb-2 ms-2 text-[13px] text-start font-semibold'>{t("Password")}</h4>
                                        <input
                                    ...
                                    <div className='relative mt-4'>
                                        <h4 className='mb-2 ms-2 text-[13px] text-start font-semibold'>{t("Reset password")}</h4>
                                        <input
                                        ...
                                        />
                                        {errors.confirm_password && <span className='text-red-500 text-xs mt-1 ms-2'>{t("Reset password Error")}</span>}
                                        <div className={`text-2xl absolute top-[38px] ${Language === "en" ? "right-5" : "left-5"}`}>
                                            {
