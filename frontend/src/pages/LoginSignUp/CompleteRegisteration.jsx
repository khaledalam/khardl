    ...
    try {
      let response = await fetch(`${apiUrl}/register-step2`, {
        ...
        body: JSON.stringify({
          ...
          tax_registration_certificate: data.tax_registration_certificate[0],
          bank_certificate: data.bank_certificate[0],
          identity_of_owner_or_manager: data.identity_of_owner_or_manager[0],
      ...
      if (response.ok) {
        ...
        toast.success(`${t("Account creation has been completed successfully")}`);
        navigate("/dashboard");
      } else {
          ...
          >
            ...
            <div className="w-[100%]">
              ...
              <input
                ...
                {...register("commercial_registration", { required: true })}
                id="Input(1)"
                className="hidden"
                onChange={(event) => {
            ...
            <div className="w-[100%] flex flex-col items-start gap-4">
              ...
              {/* Input 7 */}
              <div className="w-[100%]">
                <div className="mb-2 font-semibold">{t("Facility Name")}</div>
                <input
                  type="text"
                  className={`h-[50px] px-4 bg-[#ececec] hover:bg-[#dadada] rounded-xl flex flex-col items-start justify-center w-[100%]`}
