            ...
            {position === 'absolute' ?
                <div className={`fixed gap-2 z-[99999999999]`}>
                    ...
                    <button
                        ...
                        className={`fixed top-[25%] left-0 bg-[var(--primary)] p-[10px] pl-[6px] rounded-r-lg transition-transform duration-300 transform ${isOpen ? 'translate-x-64' : 'translate-x-0'}`}
                    >
                        {isOpen ?
                            <FaTimes
                    ...
                    <div className={`shadow-xl drawer fixed top-0 left-0 w-64 h-full transition-transform duration-300 transform  ${isOpen ? 'translate-x-0' : '-translate-x-full'} z-[9999999]`}>
                        <Sidebar />
                    </div>
                </div>
                :
