...
return [
    ...
    "time-in-24-h"=>"التوقيت بال ٢٤ ساعه",
    "time"=>"الوقت",
    ...
    "Update" => "تعديل",
    "Your estimated sales (Monthly)"=>"مبيعاتك المقدرة (شهريا)",
    "Range"=>"يتراوح",
    "Nationality"=>"جنسية",
    "Your Identification"=>"هويتك",
    "National ID"=>"الهوية الوطنية",
    "Charge Back"=>"رد المبالغ المدفوعة",
    "Refund"=>"استرداد",
    "General approval"=>"موافقة عامة",
    "Terms and conditions"=>"الأحكام والشروط",
    "Your website Channel"=>"موقع الويب الخاص بك",
    "Facebook page, instagram, website"=>"صفحة الفيسبوك، الانستغرام، الموقع",
    "Legal Entity (Commercial Registration)"=>"الكيان القانوني (السجل التجاري)",
    "Is Entity Licensed"=>"هل الكيان مرخص",
    "Bank Name"=>"اسم البنك",
    ...
    "You need to configure your payment account to start selling" => "تحتاج إلى انشاء بوابة الدفع الخاص بك لتنشيط مطعمك",
