...
function Card(props) {
    ...
    return (
        <>
            <div
                className={`text-[18px]} ${divWidth <= 1200 ? "w-[250px]" : ""} `}
            >
                <div
                ...
                >
                    <button className="" onClick={() => showMeDetailesItem()}>
                            ...
                            <div
                                ...
                                style={
                                    shapeImageShape === "14px"
                                        ? {
                                              padding: "5px",
                                              borderRadius: `${GlobalShape} ${GlobalShape} ${shapeImageShape} ${shapeImageShape}`,
                        ...
                        <h2
                            className="my-3 px-3 text-[15px] font-bold"
                            style={{
                                display: "-webkit-box",
                        ...
                        <h2
                            className="my-3 px-3 text-[14px] text-start"
                            style={{
                                display: "-webkit-box",
                                WebkitBoxOrient: "vertical",
                                WebkitLineClamp: 1,
                    ...
                    <button
                        className="text-center bg-[var(--primary)] py-1 text-black font-bold"
                        style={{
                            borderRadius: `0 0 ${GlobalShape} ${GlobalShape}`,
