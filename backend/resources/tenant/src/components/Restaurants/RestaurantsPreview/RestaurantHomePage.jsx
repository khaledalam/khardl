...
const RestaurantHomePage = (props) => {
    ...
    return (
        <div
            ...
            style={{
                fontFamily: `${styleDataRestaurant?.font_family}`,
                fontWeight: `${styleDataRestaurant?.font_type}`,
                fontSize: `${styleDataRestaurant?.font_size}`,
            }}
        >
            <div className="">
                <div
                    className={`${
                        styleDataRestaurant?.logo_alignment === "Center"
                            ? "justify-center"
                            : ""
                    }
        ${
            styleDataRestaurant?.logo_alignment === "Left" && Language === "en"
                ? "justify-start"
                : styleDataRestaurant?.logo_alignment === "Left"
                  ? "justify-end"
                  : ""
        }
        ${
            styleDataRestaurant?.logo_alignment === "Right" && Language === "en"
                ? "justify-end"
                : styleDataRestaurant?.logo_alignment === "Right"
                  ? "justify-start"
                  : ""
        }
                    ...
                    <div>
                        ...
                        >
                            {categoriesForBranch?.length > 0 ? (
                                <Taps
                                    contentClassName={`
        bg-[var(--secondary)] mb-5 ${
            styleDataRestaurant?.category_style === "Carousel"
                ? `flex justify-center`
                : ""
        } text-xl
        ${
            styleDataRestaurant?.category_style === "Right" ||
            styleDataRestaurant?.category_style === "Left"
                ? "min-w-[180px]  mx-[15px] p-2 rounded-md"
                : "px-[30px]"
        }`}
                                >
