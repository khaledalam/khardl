...
function Header() {
  ...
  const GlobalColor =
    styleDataRestaurant?.primary_color || sessionStorage.getItem("globalColor");
  ...
  return (
    <div
      className={`flex items-start justify-between p-[12px] px-8 bg-[var(--secondary)]`}
    >
      ...
      <div className="flex items-center justify-between gap-4">
        ...
        >
          ...
          <span className="text-center flex items-center justify-center absolute top-[-7px] right-[-6px] text-[10px] text-bold h-[20px] w-[20px] rounded-full bg-red-500 text-white">
