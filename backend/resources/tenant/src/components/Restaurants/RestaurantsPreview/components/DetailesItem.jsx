            ...
            <div className='modal-wrapper flex items-center z-[50]'>
              <div className='modal max-w-md min-w-[480px]  bg-white overflow-y-auto mx-5 xl:max-w-xl lg:max-w-xl md:max-w-xl max-h-screen shadow-lg flex-row rounded-lg'>
                <div className='modal-header grid grid-cols-2 p-5 items-center border-b border-ternary-light'>
                  ...
                  <button onClick={onClose} className='font-bold col-end-7'>
                    <FiX className='text-2xl' />
                  </button>
                </div>
                <div className='modal-body p-5 w-full h-full'>
                  <div
                    className='w-full h-[150px] bg-center bg-cover'
                    style={
                  ...
                  <div className='max-w-xl m-4 text-start'>
                    ...
                    {checkbox_input_titles.map((title, checkbox_index) => (
                      <div
                        key={`checkboxTitle ${checkbox_index}`}
                        className='border-b border-ternary-light my-2 mx-10 p-4'
                      >
                        <div className='text-[16px] font-semibold'>
                          {Language == "en" ? title[0] : title[1]}
                          {checkbox_required[checkbox_index] == "true" && (
                            <span className='text-red-500'>*</span>
                          )}
                        </div>
                        <div className='flex justify-between items-center'>
                          <div>
                            {checkboxItems[checkbox_index].map(
                              (item, index) => (
                                <div
                                  key={`checkbox ${checkbox_index} ${index}`}
                          ...
                          <div className='flex  flex-col items-center'>
                            {checkboxItems[checkbox_index].map(
                              (item, index) => (
                                <div
                                  key={`checkboxPrice ${checkbox_index} ${index}`}
                                  className='text-[14px]'
                                >
                                  {item.price == 0
                                    ? t("Free")
                    ...
                    {selection_input_titles.map((title, selection_index) => (
                      <div
                        key={`selectionTitle ${selection_index}`}
                        className='border-b border-ternary-light mx-10 p-4'
                      >
                        <div className='text-[16px] font-semibold '>
                          {Language == "en" ? title[0] : title[1]}
                          {selection_required[selection_index] == "true" && (
                            <span className='text-red-500'>*</span>
                          )}
                        </div>
                        <div className='flex justify-between items-center'>
                          <div>
                            {radioItems[selection_index]?.map((item, index) => (
                              <div
                                key={`selection ${selection_index} ${index}`}
                                className='flex justify-start items-center gap-2'
                              >
                                <input
                                  id={`radio-${index}`}
                                  ...
                                  onChange={(e) =>
                                    handleRadioChange(selection_index, index, e)
                                  }
                                  className='w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 focus:ring-2'
                                />
                                <label
                          ...
                          <div className='flex  flex-col items-center'>
                            {radioItems[selection_index]?.map((item, index) => (
                              <div
                                key={`selectionPrice ${selection_index} ${index}`}
                                className='text-[14px]'
                              >
                                {item.price == 0
                                  ? t("Free")
                    ...
                    {dropdown_input_titles.map((title, dropdown_index) => (
                      <div
                        key={`dropdownTitle ${dropdown_index}`}
                        className='border-b border-ternary-light mx-10 p-3 '
                      >
                        <div className=''>
                          <div className='text-[16px] font-semibold '>
                            {Language == "en" ? title[0] : title[1]}
                            {dropdown_required[dropdown_index] == "true" && (
                              <span className='text-red-500'>*</span>
                            )}
                          </div>
                          <div className='relative w-[100%] my-2'>
                            <select
                              onChange={(e) =>
                                handleDropdownChange(dropdown_index, e)
                              }
                            ...
                            >
                              <option
                                ...
                                defaultValue
                              ></option>
                              {dropdownItems[dropdown_index]?.map(
                                (item, index) => (
                                  <option
                                    className='bg-white text-black'
                                    key={`dropdown ${dropdown_index} ${index}`}
                                    value={index}
                                  >
                                    {" "}
                                    {Language == "en"
                    ...
                    <div className='border-b border-ternary-light my-2 mx-10 p-4'>
                      <div className=''>
                        ...
                        <textarea
                          className='w-[100%] bg-[var(--secondary)] p-1'
                    ...
                    <div className='flex justify-between items-center my-2 mx-10 p-4'>
                      ...
                      <div className='flex justify-center items-center rounded-[80px]'>
                        ...
                        <div
                          className={`w-[40px] bg-[var(--third)] text-center ${
                            GlobalShape == "20px" ? "mx-1" : ""
                          }`}
                    ...
                    <div className='flex justify-center items-center my-4 pb-8'>
                      <button
                        className={
                          "p-1 px-10 text-[16px] text-black font-bold " +
                          isLoggedIn
                            ? " bg-[var(--primary)] "
                            : " bg-[var(--secondary)] "
                        }
                        ...
                        onClick={() =>
                          isLoggedIn ? handleAddToCart() : navigate("/login")
                        }
                      >
                        {isLoggedIn && (
                          <>
                      ...
                      {goToCart && (
                        <button
                          ...
                          className={
                            "p-1 px-3 bg-[var(--secondary)] text-[16px] text-black font-bold"
                          }
                        >
                          {t("go to cart")}
                        </button>
