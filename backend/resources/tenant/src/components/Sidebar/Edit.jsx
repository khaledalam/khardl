...
function Edit() {
  ...
  const selectedAlignText = useSelector(
    (state) => state.alignText.selectedAlignText,
  );
  ...
  useEffect(() => {
    fetch(
      "https://www.googleapis.com/webfonts/v1/webfonts?key=AIzaSyCAQ84qDJQa8z0n-jwL3DzAdV-prndG4-s",
    )
    ...
    buttons.forEach((button) => {
      dispatch(
        updateButton({
          id: button.id,
          newText: button.text,
          newColor: GlobalColor,
          newShape: button.shape,
        }),
      );
    });
    ...
    buttons.forEach((button) => {
      dispatch(
        updateButton({
          ...
          newShape: GlobalShape,
        }),
      );
    });
    dispatch(
      updateGlobalButtons({
        newGlobalColor: GlobalColor,
        newGlobalShape: GlobalShape,
      }),
    );
  };
      ...
      <div className="flex justify-between items-center p-4 pt-6 pb-2">
        ...
        <input
          ...
          onChange={(e) => {
            ...
            handleGlobalColorChange(e.target.value);
          }}
        />
      </div>
          ...
          <Shape
            component={
              <div className="flex justify-between items-center px-1 gap-2">
                ...
                <Shape
                  component={<div className="w-3 h-2" />}
                  contentClassName="rounded-none bg-[var(--third)] px-1"
          ...
          <Shape
            component={
              <div className="flex justify-between items-center px-1 gap-2">
                ...
                <Shape
                  component={<div className="w-3 h-2"></div>}
                  contentClassName="!rounded-[4px] bg-[var(--third)] px-1"
          ...
          <Shape
            component={
              <div className="flex justify-between items-center px-1 gap-2">
                ...
                <Shape
                  component={<div className="w-3 h-2"></div>}
                  contentClassName="!rounded-full bg-[var(--third)]  px-1"
      ...
      <div className="p-4 py-2">
        ...
        <div className="mt-2 flex flex-col gap-2">
          <div className="relative w-[100%]">
            ...
            <MdKeyboardArrowDown
              className={`absolute top-1/2 ${Language == "en" ? "right-4" : "left-4"} transform -translate-y-1/2 text-black`}
            />
          </div>
        ...
        <div className="flex justify-center items-center gap-6 mt-6">
          <button
            onClick={() =>
              handleAlignTextChange(Language === "en" ? "Left" : "Right")
            }
            className={`
                    ${
                      selectedAlignText === "Left" && Language === "en"
                        ? "text-[var(--primary)]"
                        : selectedAlignText === "Right" && Language === "ar"
                          ? "text-[var(--primary)]"
                          : ""
                    }
                    `}
          ...
          <button
            onClick={() =>
              handleAlignTextChange(Language === "en" ? "Right" : "Left")
            }
            className={`
                    ${
                      selectedAlignText === "Right" && Language === "en"
                        ? "text-[var(--primary)]"
                        : selectedAlignText === "Left" && Language === "ar"
                          ? "text-[var(--primary)]"
                          : ""
                    }
                    `}
