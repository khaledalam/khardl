...
const Supports = () => {
  ...
  return (
    <div
      className={`z-[9999999999] fixed max-[450px]:bottom-3  bottom-6 ${Language === "en" ? "right-6 max-[450px]:right-4" : "left-6 max-[450px]:left-4"}  flex flex-col items-end justify-end`}
    >
      {open && (
        <div
          className="w-[280px] h-[350px] p-6 bg-white mb-4 rounded-xl shadow-lg z-[99999999999999]"
          style={{
