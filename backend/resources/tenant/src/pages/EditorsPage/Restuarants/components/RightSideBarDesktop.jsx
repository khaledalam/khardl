...
export const RightSideBarDesktop = ({
  ...
  useEffect(() => {
    activeSubitem != null &&
      console.log("now : ", navItems[activeSection].subItems[activeSubitem]);
            ...
            Object.keys(navItems[activeSection].subItems[activeSubitem])
              ...
              .map((item, index) => (
                <li key={index}>
                  ...
                  >
                    {navItems[activeSection].subItems[activeSubitem][item].map(
                      (subItem, subIndex) => {
                        return (
                          <li key={subIndex} className="py-1 xl:py-3">
