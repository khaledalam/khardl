    ...
    },
    {
      ...
      subItems: [
        ...
        },
        {
          ...
          layout: ["color"],
          layoutInitialValues: [terms_and_conditions_color],
          layoutOnChange: [(color) => dispatch(termsAndConditionsColor(color))],
          contentPosition: ["positionContent"],
          contentPositionInitialValues: [terms_and_conditions_alignment],
          contentPositionOnChange: [
            (value) => dispatch(termsAndConditionsAlignment(value)),
          ],
          text: ["font", "weight", "size", "color"],
          textInitialValues: [
            terms_and_conditions_text_fontFamily,
          ...
          textOnChange: [
            (value) => dispatch(termsAndConditionsTextFont(value)),
            (value) => dispatch(termsAndConditionsTextWeight(value)),
            (value) => dispatch(termsAndConditionsTextSize(value)),
            (color) => dispatch(termsAndConditionsTextColor(color)),
          ],
          link: [],
        },
        {
          ...
          layout: ["color"],
          layoutInitialValues: [privacy_policy_color],
          layoutOnChange: [(color) => dispatch(privacyPolicyColor(color))],
          contentPosition: ["positionContent"],
          contentPositionInitialValues: [privacy_policy_alignment],
          contentPositionOnChange: [
            (value) => dispatch(privacyPolicyAlignment(value)),
          ],
          text: ["font", "weight", "size", "color"],
          textInitialValues: [
            privacy_policy_text_fontFamily,
          ...
          textOnChange: [
            (value) => dispatch(privacyPolicyTextFont(value)),
            (value) => dispatch(privacyPolicyTextWeight(value)),
            (value) => dispatch(privacyPolicyTextSize(value)),
            (color) => dispatch(privacyPolicyTextColor(color)),
          ],
          link: [],
        },
      ],
