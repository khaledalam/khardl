          ...
          {Language === "en" ? (
            <div className="container ">
              ...
              <p>
                ...
                "contract" between Khardl, Inc. Registered in the Kingdom of
                Saudi Arabia as Dannf Company Ltd. with Commercial Registration
                No.: 1010794210, and these User Terms govern your use of the
                KHARDL services, which is an electronic platform that acts as an
                electronic portal that allows customers to receive and manage
                orders ("Services") as the use of any person was KHARDL, whether
                a merchant, consumer or otherwise, this is considered approval
                and acceptance from him and he is fully qualified considered
                Shariah, system and law for all articles, terms and provisions
                of this agreement and is a confirmation of your commitment to
                its regulations and what It is stated, and we point out to you
                that KHARDL may be (a website, mobile application or electronic
                platform) and this agreement is valid and effective once you
              ...
              <p>
                ...
                includes all forms of the Danish Company Ltd. on the Internet,
                whether it is an electronic application, or a website on the
                Internet.
              </p>
              <p></p>
              <p>
                • "Customer" means any merchant engaged in KHARDL and KHARDL
                services.
              </p>
              <p></p>
              <p>
              ...
              <p></p>
              <p>
                • "Service Provider" means the services that KHARDL provides to
                customers through third parties, and the provision of services
              ...
              <p>
                ...
                Services has never been disabled or prevented from using them at
                any time.
              </p>
              <p></p>
              <p>
                • You have full power and authority to contract and you will not
              ...
              <p>
                • Not modify, trim, translate, summarize, create a sub-work
                based on decompiling, reverse engineering the design of the
                KHARDL application or otherwise identify or attempt to identify
                or attempt to access the source code, the internal design of the
                Services or any text, multimedia images (images, audio, video
                files), data or other information provided by KHARDL or third
                party service providers.
              </p>
              <p></p>
              <p>
                • Not to delete, change, or otherwise modify any copyright or
                other official notices contained in the Services.
              </p>
              <p>
                • Not to intentionally transfer, distribute or allow the
                Services to be downloaded for use other than as specified
                herein.
              </p>
              <p></p>
              <p></p>
              ...
              <p>
                • Responsible for the periodic maintenance of the "KHARDL"
                system
              </p>
              <p></p>
              <p>
                • Responsible for managing the infrastructure of servers and
                their services provided by a third party.
              </p>
              <p>
                • Committed to taking all measures and making every effort to
                ensure the functioning of the third party services associated
                with "KHARDL"
              </p>
              <p></p>
              ...
              <p></p>
              <p>
                • Complies with all laws and regulations in force in his
                country.
              </p>
              <p></p>
              <p>
                • Provides correct and accurate information to "Khardl" and
                updates it periodically.
              </p>
              <p></p>
              <p>
                • Review and comply with any notices sent through "Khardl"
                regarding its use of the services provided "Khardl".
              </p>
              <p></p>
              <p>
                • It will not duplicate sublicenses, issue, publish, transfer,
                distribute, perform, offer, sell, or reclassify the Khardl
              ...
              <p>
                ...
                purpose except for commercial use and will use the System and
                the Service exclusively for its own purposes and will not sell
                it to any third party (including but not limited to providing
                any Service to any other person).
              </p>
              <p></p>
              <p>
                • Uses the Service or App for lawful purposes only, and will not
                use the Services to damage, harm, harass or trespass on the
                property of others or for any illegal purpose.
              </p>
              <p>
                • It will not hinder the proper operation of the "Khardl"
                system.
              </p>
              <p></p>
              <p>
                • It will not attempt to harm the Service or the App in any way.
              </p>
              <p></p>
              <p>
                • The system or other content will not be copied or distributed
                without the prior written permission of Khardl.
              </p>
              <p></p>
              <p>
                • Be responsible for all login information for his account such
              ...
              <p>
                ...
                stores and applications, whether they were owned by them before
                or after the establishment of the site or application.
              </p>
              <p></p>
              <p>
                • The Merchant agrees to the intellectual property rights of
                KHARDL, including the platform, and other words, logos and
                symbols of KHARDL or displayed on KHARDL, as KHARDL, and each
                right that follows KHARDL, are protected by intellectual
                property rights and trademark laws and are the exclusive
                property of KHARDL and in no way may they be infringed or used
                without authorization from the KHARDL administration , Khardl
              ...
              <p>
                ...
                before and after subscription, and it is your responsibility to
                stay informed of the current prices of the services provided.
              </p>
              <p>
                As a customer, you must pay for the services by bank transfer or
                credit cards and authorize the card issuer to pay, as soon as
                the service is provided to you. You are solely responsible for
                the timely payment of all fees and acknowledge that any amount
              ...
              <p>
                ...
                referred to in these Terms and Conditions of Use.
              </p>
              <p></p>
              <p>
                2. Violate any rights of third parties, including service
                providers.
              </p>
              <p></p>
              <p>
              ...
              <p>
                ...
                caused by malware or viruses that infect the general software
                beyond its control, unless such damage is caused by intentional
                misconduct or gross negligence on the part of KHARDL.
              </p>
              <p></p>
              <p>
                The quality of the third-party services associated with KHARDL
                is the responsibility of the service provider. Under no
                circumstances shall KHARDL assume any responsibility in
              ...
              <p></p>
              <p>
                • Change the Services or any materials associated with them;
                and/or stop publishing their Services.
              </p>
              <p>
                • If KHARDL decides to stop publishing its services, it may
                voluntarily replace the services with other similar materials.
              </p>
              <p>
              ...
              <p>
                ...
                anyone else using your account and/or username, password or
                access credentials. You agree to notify KHARDL if you become
                aware of any loss, theft, fraud, unauthorized use of any
                password, username, IP address, or other methods of accessing
                the Services and HADL undertakes to follow all possible means to
              ...
              <p>
                ...
                from time to time, for example, for example, tax certificate or
                logo of payment companies or delivery companies. These links
                take you outside the site, application and service, knowing that
                these sites have independent terms and conditions as well as an
                independent privacy policy, and are outside the control of
                KHARDL.
              </p>
              <p></p>
              <p>
                Please note that these other sites may send their own cookies to
                users, collect their data, or request personal information, and
                therefore, we recommend that you check the terms of use or
              ...
              <p>
                ...
                customer will be notified through the approved communication
                channels such as e-mail thirty days in advance.
              </p>
              <p></p>
              <p>
                • The customer has no right to choose to provide online payments
                except through payment gateways linked to KHARDL.
              </p>
              <p></p>
              <p>
                • KHARDL has nothing to do if the payment method chosen by the
                consumer is "cash".
              </p>
              <p></p>
              <p>
                • KHARDL has the right to stop or modify the electronic payment
                service through which it is provided directly, and stores will
                be notified 60 days in advance.
              </p>
              <p>
                • In the event that there is a suspicion of fraud by banks or
                credit card companies on the transactions, KHARDL will provide
                all the documents required by banks or credit card companies,
                knowing that the decision to prove the fraud is taken by those
                parties, and upon proof, the amount will be deducted from the
                customer by the bank.
              </p>
              <p></p>
              <p>
                • KHARDL provides payment service through its partners and is
                therefore not responsible for delayed operations in cases of
                returns and others.
              </p>
              <p></p>
              ...
              <p>
                ...
                affect the validity of the other provisions contained therein.
              </p>
              <p>
                In the event of any invalid provision in these Terms of User or
              ...
              <p>
                ...
                users and prevent access to information unless the person is
                authorized to access it. Also, KHARDL has no control over the
                third-party services associated with it, such as delivery
                companies, electronic payment gateways, or software libraries on
                the site or application, knowing that all these services have
              ...
              <p>
                ...
                replace any provision of these User Terms, or to change, suspend
                or discontinue the Service or Application (including without
                limitation, the provision of any feature, database or content)
                at any time, by posting a notice on the Site or by sending you a
                notification through the Service, Application or by email.
                KHARDL may also place restrictions on certain features and
                services or limit your access to portions of the Service or the
              ...
              <p>
                ...
                service or application, by sending an email to your postal
                address registered in the account information with "KHARDL", or
                by sending a correspondence by regular mail to your address
              ...
              <p>
                ...
                settlement of any dispute, claim or controversy arising out of
                or relating to these User Terms or any violation thereof,
                termination, execution, interpretation, correctness or use of
                the Site, Service or App, shall be governed by and construed in
            ...
            <div className="container">
              ...
              <p>
                تمثل هذه الضوابط والشروط اتفاق رسمي “عقد” بين “خردل- Khardl,
                Inc.” والمسجلة في المملكة العربية السعودية بإسم شركة دنف
                المحدودة ذات سجل تجاري رقم: 1010794210 ، وتحكم شروط المستخدم هذه
                استخدامكم لخدمات خردل والتي هي عبارة منصة إلكترونية تعمل كبوابة
                إلكترونية تتيح للعملاء إستقبال الطلبات وإدارتها (“الخدمات”) حيث
                أن استخدام أي شخصٍ كان لخردل سواءً كان تاجراً أو مستهلكاً أو غير
                ذلك فإن هذا يُعد موافقة وقبول منه وهو بكامل أهليته المعتبرة
                شرعاً ونظاماً وقانوناً لكافة مواد وبنود وأحكام هذه الاتفاقية وهو
                تأكيد لالتزامكم بأنظمتها ولما ذُكر فيها، ونشير إليكم بأن خردل قد
                تكون عبارة عن ( موقع إلكتروني أو تطبيق على الهواتف المحمولة أو
              ...
              <p>
                ...
                الخدمة من العميل وذلك عن طريق متجر التاجر الالكتروني الذي أسسه
                عبر خردل.
              </p>
              <p>
                • “الاتفاقية” يقصَد بهذه العبارة قواعد وشروط وأحكام استخدام منصة
                خردل، أي كافة أحكام وشروط هذه الاتفاقية، والتي تحكم وتنظّم
                العلاقة فيما بين أطراف هذه الاتفاقية.
              </p>
              <p>
                • “مزود الخدمة” يقصَد بهذه العبارة الخدمات التي تقوم خردل
              ...
              <p>
                ...
                للحصول على خدماتنا واستخدامها .
              </p>
              <p>
                • عدم إتاحة الخدمات أو تأجير، أو استئجار أو تخصيص أو إعادة بيع،
                أو توزيع أو ترخيص من الباطن لهذه الخدمات إلى أي طرف ثالث.
              </p>
              <p>
                • عدم تعديل، أو اجتزاء، أو ترجمة، أو تلخيص، أو إنشاء عمل فرعي
                يقوم على فك، أو تنفيذ هندسة عكسية لتصميم تطبيق خردل أو خلاف ذلك
                من تحديد أو محاولة تحديد أو محاولة الوصول إلى شفرة المصدر أو
                التصميم الداخلي للخدمات أو أي نص، أو صور الوسائط المتعددة (صور،
                صوتيات، ملفات فيديو)، أو البيانات أو غيرها من المعلومات التي
                تقدمها خردل أو الطرف الثالث من مقدمي الخدمة.
              </p>
              <p>
                • عدم حذف، أو تغيير، أو غير ذلك من التعديل على أي حق من حقوق
                النشر أو غيرها من الإخطارات الرسمية الواردة في الخدمات.
              </p>
              <p>
              ...
              <p>
                • يقدم معلومات صحيحة ودقيقة إلى “خردل – Khardl” والقيام بتحديثها
                بشكل دوري.
              </p>
              <p>
                • يراجع ويمتثل لأي إشعارات يتم إرسالها من خلال “خردل – Khardl”
                فيما يتعلق بإستخدامه للخدمات المقدمة “خردل – Khardl”.
              </p>
              <p>
                • لن يقوم بتكرار تراخيص من الباطن، أو إصدار، أو نشر، أو نقل، أو
                توزيع، أو تنفيذ، أو عرض، أو بيع، أو إعادة تصنيف خدمات “خردل –
                Khardl”، ولن يقوم بنقل الخدمة أواستغلالها تجارياً، بإستثناء ما
                يسمح به بموجب هذا العقد.
              </p>
              <p>
                • لن يستخدم المعلومات، أو المحتوى أو أي بيانات يصل إليها أو يحصل
                عليها من خلال خدمات “خردل – Khardl” في أي غرض آخر إلا للإستعمال
                التجاري وسوف يستخدم النظام والخدمة حصراً للأغراض الخاصة به ولن
                يبيعها لأي طرف ثالث (بما في ذلك على سبيل المثال لا الحصر تقديم
                أي خدمة إلى أي شخص آخر).
              </p>
              <p>
                • يستخدم الخدمة أو التطبيق لأغراض مشروعة فقط، ولن يستخدم الخدمات
                لإتلاف، إيذاء، مضايقة أو التعدي على ممتلكات الآخرين أو أي غرض
                غير قانوني.
              </p>
              <p>• لن يعرقل التشغيل السليم لنظام “خردل – Khardl”.</p>
              <p>
                • لن يحاول إلحاق الضرر بالخدمة أو التطبيق بأي شكل من الأشكال.
              </p>
              <p>
                • لن ينسخ أو يوزع النظام أو المحتويات الأخرى دون الحصول على إذن
                كتابي مسبق من “خردل – Khardl”.
              </p>
              <p>
              ...
              <p>
                • يوافق التاجر على حقوق الملكية الفكرية الخاصة بخردل، والتي من
                ضمنها المنصة، والكلمات والشعارات والرموز الأخرى الخاصة بخردل أو
                المعروضة على خردل، حيث أن خردل، وكل حق يتبع خردل، هي حقوق محمية
              ...
              <p>
                كعميل، يتوجب عليك دفع قيمة الخدمات عن طريق الحوالات البنكية أو
                البطاقات الائتمانية و تصرح للجهة مصدرة البطاقة بالدفع ، وفور
              ...
              <p>
                1. انتهاكك أو مخالفتك لأي شرط من شروط المستخدم الماثلة هذه أو
              ...
              <p>
                ...
                القدرة على استخدام) الموقع أو التطبيق، بما في ذلك الأضرار التي
                تسببها البرامج الضارة أو الفيروسات التي تصيب البرمجيات عامةً
                الخارجة عن الإرادة، ما لم يكن هذا الضرر ناتج عن سوء سلوك عمدي أو
                عن إهمال جسيم من جانب خردل.
              </p>
              <p>
                تقع مسؤولية جودة خدمات الطرف الثالث المرتبطة بخردل على عاتق مقدم
                الخدمة. لا تتحمل خردل تحت أي ظرف من الظروف أي مسؤولية تتعلق
                بالخدمات التي يقدمها مقدم الخدمة أو تنشأ عنها، كما لا تقبل
                المسؤولية عن أي أفعال أو تصرفات أو سلوك أو إهمال، أو جميع ما
              ...
              <p>
                ...
                و/أو اسم المستخدم أو كلمة المرور أو مسوغات الوصول الخاصة بك. كما
              ...
              <p>
                ...
                المثال للحصر، شهادة الضريبة أو شعار شركات المدفوعات أو شركات
                التوصيل. تنتقل بك تلك الارتباطات إلى خارج الموقع والتطبيق
                والخدمة علماً بأن تلك المواقع لها شروط وأحكام مستقلة وكذلك سياسة
                خصوصية مستقلة، وهي خارج نطاق سيطرة خردل.
              </p>
              <p>
                يُرجى ملاحظة أن تلك المواقع الأخرى قد ترسل ملفات تعريف الارتباط
                الخاصة بها إلى المستخدمين أو تجمع بياناتهم أو تطلب معلومات
              ...
              <p>
                في حالة وجود أي حكم باطل في شروط المستخدم الماثلة أو وجود حكم
                غير مقبول في ظروف معينة وفقًا لمعايير المعقولية والعدالة وإلى
                هذا المدى فقط، يُعمل بدلاً منه بين الطرفين بحكم يكون مقبولاً
              ...
              <p>
                ...
                أو تعليقهما أو إيقافهما (بما في ذلك على سبيل المثال لا الحصر،
                توفير أي ميزة أو قاعدة بيانات أو محتوى) في أي وقت، وذلك بنشر
                إخطار على الموقع أو بإرسال إخطار لك من خلال الخدمة أو التطبيق أو
                عبر البريد الإلكتروني. كما يجوز لـ ” خردل” أن تضع قيودًا على
