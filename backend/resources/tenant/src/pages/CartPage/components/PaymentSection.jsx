...
const PaymentSection = ({
  ...
  const [deliveryType, setDeliveryType] = useState(deliveryTypes && deliveryTypes.length > 0 ? deliveryTypes[0]?.name : "")
  const [couponDiscountValue, setCouponDiscountValue] = useState(0)
  const isLoggedIn = useSelector((state) => state.auth.isLoggedIn)
  const [paymentMethod, setPaymentMethod] = useState(paymentMethods && paymentMethods.length > 0 ? paymentMethods[0]?.name : "")
