...
const Category = React.memo(({ restaurantStyle, categories = [] }) => {
  const {
    price_color,
    text_color,
    text_alignment,
  ...
  const customStyles = useMemo(
    () => ({
      checkbox: price_background_color || "#7D0A0A",
      radio: price_background_color || "#7D0A0A",
      dropdownHover: price_background_color || "#7D0A0A",
    }),
    [price_background_color]
  );
    ...
    >
      <style>{`
        .custom-checkbox:checked {
          border-color: ${customStyles.checkbox} !important;
          --tw-ring-color: ${customStyles.checkbox} !important;
        }
        .custom-radio:checked {
          background-color: ${customStyles.radio};
        }
        .dropdown-option:hover {
          background-color: ${customStyles.dropdownHover};
        }
      `}</style>
      <div
