            ...
            {(restaurantStyle?.category_alignment === t("Center") ||
                ...
                <Fragment>
                    <div
                        ...
                        style={{
                            backgroundColor:
                                restaurantStyle.product_background_color,
                        }}
                    >
                                                ...
                                                .map((product, i) => (
                                                    <span key={i}>
                                                        <ProductItem
                                                            ...
                                                            textColor={
                                                                restaurantStyle?.text_color
                                                            }
                                                            textAlign={
                                                                restaurantStyle?.text_alignment
                                                            }
                                                            fontSize={
                                                                restaurantStyle?.text_fontSize
                                                            }
                                                            shape={
                                                                restaurantStyle?.categoryDetail_shape
                                                            }
                                                        />
                                                    </span>
                                                ))}
                        ...
                        >
                            <div className="flex-[25%] laptopXL:flex-[20%]">
                                <div
                                    style={{
                                        backgroundColor:
                                            restaurantStyle.page_category_color,
                                        borderRadius: 12,
                                    }}
                                    className="w-[90%] py-3"
                                >
                                            ...
                                            categories?.map((category, i) => (
                                                <span key={i}>
                                                    <CategoryItem
                                                        ...
                                                        alt={category.name}
                                                        hoverColor={
                                                            restaurantStyle?.category_hover_color
                                                        }
                                                        onClick={() =>
                                                            dispatch(
                                                                selectedCategoryAPI(
                                                        ...
                                                        shape={
                                                            restaurantStyle?.category_shape
                                                        }
                                                        isGrid={true}
                                                    />
                                                </span>
