  ...
  return (
    <section className="active">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="relative flex flex-col justify-start items-start md:items-center md:ms-5">
          <img
            className="w-[20%] h-auto max-w-[20%] md:w-[8%] md:max-w-[5%] md:absolute md:left-0 md:-mt-4"
            src={Ellipse5}
            alt="background"
          />
