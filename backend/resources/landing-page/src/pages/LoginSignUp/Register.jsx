        ...
        {!showTerms && !showPrivacy && (
          <div className="py-[20px] flex justify-center items-center">
            <div className="grid grid-cols-2 h-[100%] max-[860px]:flex max-[860px]:flex-col-reverse my-[80px] rounded-lg shadow-lg max-md:my-[60px] xl:max-w-[70%] max-[1200px]:w-[100%] bg-white">
                  ...
                  <div className="w-[100%] flex items-center justify-center mt-4">
                    ...
                    >
                      ...
                      <div className={"mb-2"}>
                        ...
                        <span
                          className="text-[#00000080] text-[10px] ms-2"
                        ...
                        >
                          ...
                          />{" "}
                          {t(
                            "* If your restaurant name is ABC the domain will be",
                          )}{" "}
                          {restaurantName ? restaurantName : "abc"}.khardl.com
                        </span>
                        {window.innerWidth > 870 && showTooltip && (
                          <div className="relative d-none">
                            <div
                              className={`absolute ${Language === "ar" ? "right-full" : "left-full"}`}
                            >
                              <div
                                id="tooltip3"
                                role="tooltip"
                                style={{ marginTop: "-4rem", width: "18rem" }}
                                className={`z-20 absolute transition duration-150 ease-in-out ${Language === "ar" ? "right-2" : "left-2"} shadow-lg rounded p-3 text-white bg-[#000000]`}
                              >
                                <svg
                                  className={`absolute ${Language === "ar" ? "right-0 rotate-180 right-[-0.5rem]" : "left-0"} -ml-2 bottom-0 top-0 h-full`}
                                  width="9px"
                                  height="16px"
                                  viewBox="0 0 9 16"
                                  version="1.1"
                                ...
                                <div className="ms-2 text-[13px] font-new text-[var(--customer)]">
                                  <p>
                                    {t(
                                      "* Your restaurant name will  be your domain",
                                    )}
                                  </p>
                                </div>
                              </div>
                        ...
                        {errors.restaurant_name && (
                          <span className="text-red-500 text-xs mt-1 ms-2">
                            {errors.restaurant_name.message ||
                              t("Restaurant name English Error")}
                          </span>
                        )}
                      </div>
                      ...
                      <div>
                        ...
                        {errors.restaurant_name_ar && (
                          <span className="text-red-500 text-xs mt-1 ms-2">
                            {errors.restaurant_name_ar.message ||
                              t("Restaurant Name Arabic Error")}
                          </span>
                        )}
                      </div>
                      ...
                      <div className="relative">
                        ...
                        <input
                          type={
                            openEyeRePassword === false ? "password" : "text"
                          }
                          className={`w-[100%] mt-0 p-[10px] px-[16px] max-[540px]:py-[15px] boreder-none rounded-full bg-[var(--third)]`}
                      ...
                      {errors.terms_and_policies && (
                        <span className="text-red-500 text-xs mt-1 ms-2">
                          {errors.terms_and_policies.message ||
                            t("Approval Error")}
                        </span>
                      )}
              ...
              <div
                className={`flex justify-center  max-[860px]:w-[85vw] bg-[var(--primary)] p-8 space-y-10  rounded-e-lg max-[860px]:rounded-t-lg max-[860px]:rounded-e-none new-register-bg ${direction}`}
              >
                <div className="mt-11">
                  <MainText
