...
const Login = () => {
    ...
    return (
        ...
        >
            <div className="grid grid-cols-2 max-[860px]:flex max-[860px]:flex-col-reverse py-[100px] max-md:py-[60px] xl:max-w-[60%] max-[1200px]:w-[90%]">
                <div className="relative flex flex-col justify-start  items-center max-[860px]:w-[80vw] space-y-14 shadow-lg bg-white p-8 max-[860px]:p-2 rounded-s-lg max-[860px]:rounded-b-lg max-[860px]:rounded-s-none ">
                    <div className="mt-6">
                        <MainText
                            Title={t("Login")}
