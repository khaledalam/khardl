...
const Card = ({ FeatureImage, FeatureTitle, FeatureDetails, FeaturePrice, FeatureDevice }) => {
  ...
  return (
    <div
      ...
      className={`bg-[var(--third)] rounded-lg px-4 py-8 max-[600px]:py-12 shadow-md hover:translate-y-2 ease-in duration-200 flex flex-col items-center ${FeatureDevice ? "justify-start" : "justify-center"}`}>
      {FeatureImage &&
        <div className="flex flex-col sp-2 px-6">
          <img loading="lazy"  className={`mb-2 w-[80px] h-auto`} src={FeatureImage} alt="Bonnieimage" />
        </div>
      }
