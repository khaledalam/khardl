...
const Card = ({ FeatureImage, FeatureTitle, FeatureDetails, FeaturePrice, FeatureDevice }) => {
  ...
  return (
    <div
      ...
      <div className={`bg-[var(--third)] px-4 py-8 rounded-lg hover:translate-y-2 ease-in duration-200 max-[600px]:py-12  flex flex-col items-center ${FeatureDevice ? "justify-start" : "justify-center"}`}>
        {FeatureImage &&
