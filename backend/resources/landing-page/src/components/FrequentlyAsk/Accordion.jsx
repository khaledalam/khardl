...
const Accordion = ({ question, answer, number, first }) => {
  ...
  return (
    <div className="my-2 item" data-aos="zoom-in" data-aos-delay="400">
      <button
      ...
      >
        <div className="flex justify-between w-[100%]">
          <div className="flex items-center justify-start w-[100%]">
            ...
            <div className="text-[18px] text-[#252625] text-right max-sm:text-[15px]">
              {question}
            </div>
          </div>
        ...
        {isOpen && (
          <div className="py-4 px-4 text-start text-[16px] text-[#00000090] max-sm:text-[13px]">
            {answer}
          </div>
        )}
      </button>
