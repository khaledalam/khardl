        ...
        <div class="row g-5 g-xl-10 mb-xl-10">
                ...
                <div class="card card-flush h-md-50 mb-5 mb-xl-10">
                    ...
                    <div class="card-header pt-5">
                        ...
                        <div class="card-title d-flex flex-column">
                            ...
                            <!--end::Info-->
                            <!--begin::Subtitle-->
                            <span class="text-gray-400 pt-1 fw-bold fs-6">All restaurants</span>
                            <!--end::Subtitle-->
                        </div>
                        <!--end::Title-->
                    </div>
                    ...
                    <div class="card-header pt-5">
                        ...
                        <div class="card-title d-flex flex-column">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <!--end::Amount-->
                                <!--begin::Badge-->
                                <span class="badge badge-khardl fs-base">
                    ...
                    <div class="card-body d-flex flex-column justify-content-end pe-0">
                        ...
                        <div class="symbol-group symbol-hover flex-nowrap">
                            ...
                            <div class="symbol symbol-35px symbol-circle" data-bs-toggle="tooltip"
                                 title="Susan Redwood">
                                                    <span
                                                        class="symbol-label bg-khardl text-inverse-khardl fw-bolder">S</span>
                            </div>
                            <div class="symbol symbol-35px symbol-circle" data-bs-toggle="tooltip"
                                 title="Melody Macy">
            ...
            <div class="col-md-6 col-lg-6 col-xl-6 col-xxl-4 mb-md-5 mb-xl-10">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <span class="fs-2hx fw-bolder text-dark me-2 lh-1 ls-n2">25.3
                                                        <span class="badge badge-khardl fs-base">
                                                            ...
                                                            <!--end::Svg Icon-->minutes</span>
                                                    </span>
                                <!--end::Amount-->
                            </div>
                            <!--end::Info-->
                            <!--begin::Subtitle-->
                            <span class="text-gray-400 pt-1 fw-bold fs-6">Restaurants average delivery time</span>
                            <!--end::Subtitle-->
                        </div>
                        <!--end::Title-->
                    </div>
                ...
                <div class="card card-flush h-md-50 mb-5 mb-xl-10">
                    ...
                    <div class="card-header pt-5">
                        ...
                        <div class="card-title d-flex flex-column">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <!--begin::Amount-->
                                <span
                                    class="fs-2hx fw-bolder text-dark me-2 lh-1 ls-n2">55</span>
                                <!--end::Amount-->
                                <!--begin::Badge-->
                                <span class="badge badge-khardl fs-base">
                                                        <!--begin::Svg Icon | path: icons/duotune/arrows/arr066.svg-->
                            ...
                            <!--end::Info-->
                            <!--begin::Subtitle-->
                            <span class="text-gray-400 pt-1 fw-bold fs-6">Restaurants delivery success rate</span>
                            <!--end::Subtitle-->
                        </div>
                        <!--end::Title-->
                    </div>
                    ...
                    <div class="card-body d-flex align-items-end px-0 pb-0">
                        <!--begin::Chart-->
                        <div id="kt_charts_widget_2_chart" class="w-100" style="height: 150px"></div>
                        <!--end::Chart-->
                    </div>
                    <!--end::Card body-->
                </div>
                ...
                <div class="card card-flush overflow-hidden h-md-100">
                    ...
                    <div class="card-header py-5">
                        ...
                        <div class="card-toolbar" data-kt-buttons="true">
                            <a class="btn btn-sm btn-color-muted btn-active btn-active-khardl active px-4 me-1" id="kt_charts_widget_3_year_btn">Year</a>
                            <a class="btn btn-sm btn-color-muted btn-active btn-active-khardl px-4 me-1" id="kt_charts_widget_3_month_btn">Month</a>
                            <a class="btn btn-sm btn-color-muted btn-active btn-active-khardl px-4" id="kt_charts_widget_3_week_btn">Week</a>
                        </div>
                        <!--end::Toolbar-->
                        <!--end::Title-->
                    </div>
