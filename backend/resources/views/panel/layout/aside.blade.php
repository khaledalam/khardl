<div id="kt_aside" class="aside aside-dark aside-hoverable" data-kt-drawer="true"
    ...
    <div class="aside-logo flex-column-auto" id="kt_aside_logo">
        <!--begin::Logo-->
        <a href="./index.html">
            <img alt="Logo" src="./images/logo.jpg" class="h-70px logo" />
        </a>
        <!--end::Logo-->
        <!--begin::Aside toggler-->
            ...
            <div class="menu menu-column menu-title-gray-800 menu-state-title-khardl menu-state-icon-khardl menu-state-bullet-khardl menu-arrow-gray-500"
                ...
                <div class="menu-item here show menu-accordion">
                                <span class="menu-link">
                                    ...
                                    <span class="menu-title"><a href="./index.html">
                                            Dashboards</a></span>
                                </span>
                </div>
                ...
                <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                    ...
                    <div class="menu-sub menu-sub-accordion menu-active-bg">
                        <div class="menu-item">
                            <a class="menu-link" href="./restaurants/index.html">
                    ...
                    <div class="menu-sub menu-sub-accordion menu-active-bg">
                        <div class="menu-item">
                            <a class="menu-link" href="./supports/index.html">
                                ...
                                <span class="menu-title">All Supports</span>
                            </a>
                        </div>
                        <div class="menu-item">
                            <a class="menu-link" href="./supports/create.html">
                                ...
                                <span class="menu-title">Add Supports</span>
                            </a>
                        </div>
                    </div>
                </div>
                ...
                <div class="menu-item menu-accordion">
                                <span class="menu-link">
                                    ...
                                    <span class="menu-title"> <a href="./staff/staff.html">Staff</a></span>
                                </span>
                </div>
                ...
                <div class="menu-item menu-accordion">
                                <span class="menu-link">
                                    ...
                                    <span class="menu-title"><a href="designs/support_design.html"> Design Restaurants</a></span>
                                </span>
                </div>
                ...
                <div class="menu-item menu-accordion">
                                <span class="menu-link">
                                    ...
                                    <span class="menu-title"> <a href="./log.html">Logs</a></span>
                                </span>
                </div>
                ...
                <div class="menu-item menu-accordion">
                                <span class="menu-link">
                                    ...
                                    <span class="menu-title"><a href="./setting.html"> Setting</a></span>
                                </span>
                </div>
            </div>
            <!--end::Menu-->
