                                  ...
                                  <div class="col-md-6 col-xxl-4">
                                      ...
                                      <div class="card">
                                          ...
                                          <div class="card-body d-flex flex-center flex-column p-9 pt-3">
                                              ...
                                              <!--end::Avatar-->
                                              <!--begin::Name-->
                                              <a href="{{ route('admin.view-restaurants', ['id' => $restaurant->id]) }}" class="fs-4 text-gray-800 text-hover-primary fw-bolder mb-0">{{ $restaurant->restaurant_name }} @if($restaurant->isApproved == "0")<span class="badge badge-light-warning fw-bolder">{{ __('messages.pending')}}</span>@elseif ($restaurant->isApproved == "1")<span class="badge badge-light-success fw-bolder">{{ __('messages.active')}}</span>@else <span class="badge badge-light-danger fw-bolder">{{ __('messages.denied')}}</span>@endif
                                              </a>
                                              <!--end::Name-->
                                              <!--begin::Position-->
