                                    ...
                                    <div class="card-body pt-0">
                                        ...
                                        <div class="mb-10 fv-row">
                                            ...
                                            <div class="mb-2" style="width: 50%; float: left;">
                                                ...
                                                <input type="text" name="name_ar" class="form-control" required placeholder="{{ __('Name (Arabic)')}}" value="{{ old('name_ar') }}" />
                                            ...
                                            <div class="mb-2" style="width: 50%; float: left;">
                                                ...
                                                <input type="text" name="name_en" class="form-control" required placeholder="{{ __('Name (English)')}}" value="{{ old('name_en') }}" />
                                        ...
                                        <div class="mb-10 fv-row">
                                            ...
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                            <input type="number" min="1" name="amount" class="form-control mb-2" required placeholder="{{ __('Price')}}" value="{{old('amount')}}" />
                                            <!--end::Input-->
                                            <!--begin::Description-->
