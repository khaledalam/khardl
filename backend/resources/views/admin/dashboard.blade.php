                    ...
                    <div class="card card-flush h-md-50 mb-5 mb-xl-10">
                        ...
                        <div class="card-header pt-5">
                            ...
                            <div class="card-title d-flex flex-column">
                                ...
                                <!--end::Info-->
                                <!--begin::Subtitle-->
                                <span class="text-gray-400 pt-1 fw-bold fs-6">{{ __('messages.restaurants-average-delivery-time')}}</span>
                                <!--end::Subtitle-->
                            </div>
                            <!--end::Title-->
                        </div>
                    ...
                    {{-- <div class="card card-flush h-md-50 mb-5 mb-xl-10">
                        ...
                        <div class="card-header pt-5">
                            ...
                            <div class="card-title d-flex flex-column">
                                ...
                                <!--end::Info-->
                                <!--begin::Subtitle-->
                                <span class="text-gray-400 pt-1 fw-bold fs-6">{{ __('messages.restaurants-delivery-success-rate')}}</span>
                                <!--end::Subtitle-->
                            </div>
                            <!--end::Title-->
                        </div>
