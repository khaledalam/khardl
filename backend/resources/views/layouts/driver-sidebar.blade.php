                ...
                <div class="aside-menu flex-column-fluid">
                    ...
                    <div class="hover-scroll-overlay-y my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true"
                        ...
                        <div class="menu menu-column menu-title-gray-800 menu-state-title-khardl menu-state-icon-khardl menu-state-bullet-khardl menu-arrow-gray-500"
                            ...
                            @if($user?->hasPermissionDriver('can_see_branches'))
                            <!-- Braches -->
                            ...
                            @endif
                            @if($user?->hasPermissionDriver('can_see_orders'))
                            <div data-kt-menu-trigger="click" class="menu-item menu-accordion {{ ($link == 'orders-all' || $link == 'ready-orders') ? 'show' : '' }}">
                                ...
                                <div class="menu-sub menu-sub-accordion menu-active-bg">
                                    <a href="{{route('restaurant.ready_orders')}}">
                                        <div class="{{ ($link == 'ready-orders') ? 'menu-link active' : 'menu-link ' }}">
                                            <span class="menu-bullet">
                                                <span class="bullet bullet-dot {{ ($link == 'ready-orders') ? 'bg-light' : '' }}"></span>
                                            </span>
                                            <span class="menu-title">{{__('messages.Ready orders')}}</span>
                                        </div>
                                    </a>
                                </div>
                                <div class="menu-sub menu-sub-accordion menu-active-bg">
