                                  ...
                                  <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                                      ...
                                      {{-- <div class="d-flex align-items-center flex-wrap gap-2">
                                          <a href="#" class="btn btn-sm btn-outline-secondary text-dark" data-bs-toggle="modal" data-bs-target="#kt_modal_new_target">Add new item
                                           ...
                                           <a href="#" class="btn btn-sm btn-danger" id="delete-category">Delete category</a>
                                           <script>
                                                document.addEventListener("DOMContentLoaded", function () {
                                                    document.getElementById("delete-category").addEventListener("click", function (e) {
                                                        ...
                                                        Swal.fire({
                                                            ...
                                                            if (result.isConfirmed) {
                                                                // User confirmed, make an Ajax request to delete
                                                                deleteCategory();
                                                            }
                                                        });
                                                    });
                                                    ...
                                                    function deleteCategory() {
                                                        ...
                                                        fetch("{{ route('restaurant.delete-category', ['id' => $category->id]) }}", {
                                                            ...
                                                            body: JSON.stringify({ _method: "DELETE" }), // Laravel uses _method to identify DELETE requests
                                                        })
                                                        .then((response) => {
                                                            if (response.ok) {
                                                                // Handle successful deletion, e.g., redirect or update UI
                                                                Swal.fire('Deleted!', 'Category has been deleted.', 'success');
                                                                // You may want to add further actions here
                                                            } else {
                                          ...
                                          <tbody>
                                              <tr>
                                                  ...
                                                  <td  class="text-center">
                                                      <div class="text-dark">
                                                          <!--begin::Heading-->
                                                          <span class="fw-bolder text-start">Name item </span>
                                                          <!--end::Heading-->
                                                      </div>
                                                  </td>
                                                  <!--end::Title-->
                                              ...
                                              <tr>
                                                  <td colspan="6" class="text-center">
                                                      <a href="#" class="btn btn-sm btn-outline-secondary text-dark" data-bs-toggle="modal" data-bs-target="#kt_modal_new_target"> Add new item <!--begin::Svg Icon | path: icons/duotune/arrows/arr087.svg-->
                                                          <span class="svg-icon svg-icon-2 me-3">
                                                              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                                                  <rect opacity="0.5" x="11" y="18" width="12" height="2" rx="1" transform="rotate(-90 11 18)" fill="currentColor" />
                                                                  <rect x="6" y="11" width="12" height="2" rx="1" fill="currentColor" />
