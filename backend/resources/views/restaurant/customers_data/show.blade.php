            ...
            <div class="d-flex flex-column gap-7 gap-lg-10">
                <div class="d-flex flex-wrap flex-stack gap-5 gap-lg-10">
                    ...
                    <ul class="nav nav-custom nav-tabs nav-line-tabs nav-line-tabs-2x border-0 fs-4 fw-bold mb-lg-n2 me-auto">
                        <!--begin:::Tab item-->
                        <li class="nav-item">
                            <a class="nav-link text-active-khardl pb-4 active" data-bs-toggle="tab" href="#kt_ecommerce_sales_order_summary">Order Summary</a>
                        </li>
                        <!--end:::Tab item-->
                        <!--begin:::Tab item-->
                        <li class="nav-item">
                                ...
                                <table class="table align-middle table-row-bordered mb-0 fs-6 gy-5 min-w-300px">
                                    ...
                                    <tbody class="fw-bold text-gray-600">
                                        ...
                                        <tr>
                                            ...
                                            <td class="fw-bolder text-end">
                                                <div class="d-flex align-items-center justify-content-end">
                                                    ...
                                                    <!--end::Avatar-->
                                                    <!--begin::Name-->
                                                    <a href="../../demo1/dist/apps/ecommerce/customers/details.html" class="text-gray-600 text-hover-khardl">Dan Wilson</a>
                                                    <!--end::Name-->
                                                </div>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td class="fw-bolder text-end">
                                                <a href="../../demo1/dist/apps/user-management/users/view.html" class="text-gray-600 text-hover-khardl">dam@consilting.com</a>
                                            </td>
                                        </tr>
                                        <!--end::Payment method-->
                                        <!--begin::Date-->
                                ...
                                <table class="table align-middle table-row-bordered mb-0 fs-6 gy-5 min-w-300px">
                                    ...
                                    <tbody class="fw-bold text-gray-600">
                                        ...
                                        <tr>
                                            ...
                                            <td class="fw-bolder text-end">
                                                <a href="../../demo1/dist/apps/invoices/view/invoice-3.html" class="text-gray-600 text-hover-khardl">#INV-000414</a>
                                            </td>
                                        </tr>
                                        <!--end::Invoice-->
                                        <!--begin::Shipping-->
                                        <tr>
                                            ...
                                            <td class="fw-bolder text-end">
                                                <a href="#" class="text-gray-600 text-hover-khardl">#SHP-0025410</a>
                                            </td>
                                        </tr>
                                        <!--end::Shipping-->
                                        <!--begin::Rewards-->
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <!--begin::Title-->
                                                            <div class="ms-5">
                                                                <a href="../../demo1/dist/apps/ecommerce/catalog/edit-product.html" class="fw-bolder text-gray-600 text-hover-khardl">Product 1</a>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <!--begin::Title-->
                                                            <div class="ms-5">
                                                                <a href="../../demo1/dist/apps/ecommerce/catalog/edit-product.html" class="fw-bolder text-gray-600 text-hover-khardl">Footwear</a>
                                                                <div class="fs-7 text-muted">Delivery Date: 30/03/2022</div>
                                                            </div>
                                                            <!--end::Title-->
                                                        </div>
