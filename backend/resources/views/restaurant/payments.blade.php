...
@section('content')
    ...
    <div class="alert alert-warning">
        Your TAP account is not approved yet, please <a href="{{route('tap.payments_upload_tap_documents')}}"><u>upload your TAP documents</u></a>.
    </div>
    @elseif ($user->submitedTapDocuments == 1)
          <div class="alert alert-success">
            Your TAP account is approved. Congratulations!
          </div>
    @endif
