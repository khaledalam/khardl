            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="d-flex flex-column mb-8 fv-row">
                        ...
                        <!--end::Label-->
                        <input type="text" class="form-control form-control-solid" required placeholder="{{__('messages.Enter Business Name (EN)')}}" name="brand[name][en]"  value="{{old('brand.name.en')}}" />
                    </div>
                    <!--end::Input group-->
                    ...
                    <div class="d-flex flex-column mb-8 fv-row">
                        ...
                        <!--end::Label-->
                        <input type="text" class="form-control form-control-solid"  placeholder="{{__('messages.Enter Business Name (AR)')}}" name="brand[name][ar]" id="name_ar"  value="{{old('brand.name.ar')}}"/>
                    </div>
                    <!--end::Input group-->
                     <!--begin::Input group-->
                    <div class="d-flex flex-column mb-8 fv-row">
                        ...
                        <!--end::Label-->
                        <input type="text" class="form-control form-control-solid"  placeholder="{{__('messages.Facebook page, instagram, website')}}" name="brand[channel_services][address]"   value="{{old('brand.channel_services.address')}}"/>
                    </div>
                    <!--end::Input group-->
                ...
                <div  class="col-md-6">
                    ...
                    <div class="d-flex flex-column mb-8 fv-row">
                        ...
                        <!--end::Label-->
                        <select id="countrySelect" class="form-select" name="entity[nationality]"  ></select>
                    </div>
                    <div class="d-flex flex-column mb-8 fv-row">
                        <!--begin::Label-->
                        <label class="d-flex align-items-center fs-6 fw-bold mb-2" >
                        ...
                        <!--end::Label-->
                        <input type="text" class="form-control form-control-solid" required placeholder="{{__('messages.National ID')}}" name="user[identification][number]"  value="{{old('user.identification.number')}}" />
                    </div>
                    <!--end::Input group-->
                ...
                <div class="col-md-6">
                    ...
                    <input id="bank_account_swift_code" type="text" class="form-control form-control-solid" name="wallet[bank][name]" required value="{{old('wallet.bank.name')}}" /><br />
                    <label class="d-flex align-items-center fs-6 fw-bold mb-2" for="bank_account_iban">
                        <span class="">{{__('messages.Company Name')}}<span class="text-danger h4"> * </span></span>
                        
                    </label>
                    <input id="bank_account_swift_code" type="text" class="form-control form-control-solid"   name="wallet[bank][account][name]" required  value="{{old('wallet.bank.account.name')}}"/><br />
                    <label class="d-flex align-items-center fs-6 fw-bold mb-2" for="bank_account_iban">
                        <span class="">{{__('messages.IBAN')}}<span class="text-danger h4"> * </span></span>
                        
                    </label>
                    <input id="bank_account_iban" type="text" class="form-control form-control-solid"   name="wallet[bank][account][iban]" required  value="{{old('wallet.bank.account.iban')}}" /><br />
                    <label class="d-flex align-items-center fs-6 fw-bold mb-2" for="bank_account_iban">
                        <span class="">{{__('messages.Swift code')}}<span class="text-danger h4"> * </span></span>
                        
                    </label>
                    <input id="bank_account_swift_code" type="text" class="form-control form-control-solid" name="entity[bank_account][account][swift]" required  value="{{old('entity.bank_account.account.swift')}}" /><br />
                    <label class="d-flex align-items-center fs-6 fw-bold mb-2" for="bank_account_iban">
                        <span class="">{{__('messages.Account number')}}<span class="text-danger h4"> * </span></span>
                        
                    </label>
                    <input id="bank_account_number" type="text" class="form-control form-control-solid"  name="entity[bank_account][account][number]" required  required value="{{old('entity.bank_account.account_number')}}" />
                ...
                <div class="col-md-6">
                    ...
                    <div class="d-flex flex-column mb-8 fv-row">
                        ...
                        <!--end::Label-->
                        <input type="text" class="form-control form-control-solid" required  name="entity[license][number]"  value="{{old('entity.license.number')}}" />
                    </div>
                    <!--begin::Input group-->
                    <div class="d-flex flex-column mb-8 fv-row">
                        <!--begin::Label-->
                        ...
                        <!--end::Label-->
                        <input type="text" class="form-control form-control-solid" required  name="entity[license][city]"  value="{{old('entity.license.city')}}"  />
                    </div>
                    <!--end::Input group-->
                    <div class="d-flex flex-column mb-8 fv-row">
                        <!--begin::Label-->
                    ...
                    <div class="form-check" style="margin:10px 0px">
                        <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault" checked name="brand[terms][general]">
                        <label class="form-check-label" for="flexCheckDefault">
                            {{__('messages.General approval')}}
                        </label>
                      </div>
                      <div class="form-check" style="margin:10px 0px">
                        <input class="form-check-input" type="checkbox" value="" id="flexCheckChecked2" checked name="brand[terms][chargeback]">
                        <label class="form-check-label" for="flexCheckChecked2">
                            {{__('messages.Charge Back')}}
                        </label>
                      </div>
                      <div class="form-check" style="margin:10px 0px">
                        <input class="form-check-input" type="checkbox" value="" id="flexCheckChecked3" checked name="brand[terms][refund]">
                ...
                <div class="col-md-6">
                        ...
                        <div id="contact_person_group">
                            ...
                            <div class="d-flex flex-column mb-8 fv-row">
                                ...
                                <!-- Input -->
                                <input type="text" class="form-control form-control-solid" required placeholder="{{ __('messages.Mr') }}" name="user[name][title]" id="name_title" value="{{ old('contact_person.name.title')  ?? 'Mr'}}" />
                            </div>
                            ...
                            <div class="d-flex flex-column mb-8 fv-row">
                                ...
                                <!-- Input -->
                                <input type="text" class="form-control form-control-solid" required placeholder="{{ __('messages.Enter First Name') }}" name="user[name][first]" id="name_first" value="{{ old('contact_person.name.first')  }}" />
                            </div>
                            ...
                            <div class="d-flex flex-column mb-8 fv-row">
                                ...
                                <!-- Input -->
                                <input type="text" class="form-control form-control-solid" required placeholder="{{ __('messages.Enter Middle Name') }}" name="user[name][middle]" id="name_middle" value="{{ old('contact_person.name.middle') }}" />
                            </div>
                            ...
                            <div class="d-flex flex-column mb-8 fv-row">
                                ...
                                <!-- Input -->
                                <input type="text" class="form-control form-control-solid" required placeholder="{{ __('messages.Enter Last Name') }}" name="user [name][last]" id="name_last" value="{{ old('contact_person.name.last')}}" />
                            </div>
                        </div>
                        <!--begin::Input group-->
                        <div class="d-flex flex-column mb-8 fv-row">
                            ...
                            <input type="text" class="form-control form-control-solid" required name="user[phone][number]"   value="{{ old('user.phone.number') }}" />
                            </div>
                        </div>
                        ...
                        <div class="d-flex flex-column mb-8 fv-row">
                            ...
                            <!--end::Label-->
                                <input id="is_licensed" type="checkbox" class="mx-2" name="user[phone][type][primary]"  {{old('user.phone.type.primary')?'checked':''}} />
                            </label>
                        </div>
                        <div class="d-flex flex-column mb-8 fv-row">
                            <!--begin::Label-->
                            ...
                            <div class="d-flex flex-column mb-8 fv-row">
                                ...
                                <!--end::Label-->
                                <select id="countrySelect2" class="form-select" name="user[birth][country]"  ></select>
                            </div>
                            <!--begin::Input group-->
                            <div class="d-flex flex-column mb-8 fv-row">
                                <!--begin::Label-->
                                ...
                                <!--end::Label-->
                                <input type="text" class="form-control form-control-solid" required name="user[birth][city]" value="{{old('user.birth.city')}}" />
                            </div>
                             <!--begin::Input group-->
                            <div class="d-flex flex-column mb-8 fv-row">
                                <!--begin::Label-->
                                ...
                                <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                                    ...
                                    <input type="text" id="kt_ecommerce_sales_flatpickr"  class="form-control form-control-solid" required />
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-md-6">
                    ...
                    <div class="d-flex flex-column mb-8 fv-row">
                        ...
                        <!--end::Label-->
                        <input type="text" class="form-control form-control-solid" required  name="user[address][city]"  value="{{old('user.address.city')}}" />
                    </div>
                    <!--end::Input group-->
                     <!--begin::Input group-->
                     <div class="d-flex flex-column mb-8 fv-row">
                        ...
                        <!--end::Label-->
                        <input type="text" class="form-control form-control-solid" requiredname="user[address][zip_code]" value="{{old('user.address.zip_code')}}" />
                    </div>
                    <!--end::Input group--> <!--begin::Input group-->
                    <div class="d-flex flex-column mb-8 fv-row">
                        <!--begin::Label-->
                        ...
                        <!--end::Label-->
                        <input type="text" class="form-control form-control-solid" required name="user[address][line1]"  value="{{old('user.address.line1')}}" />
                    </div>
                    <!--end::Input group-->
                    <!--end::Input group--> <!--begin::Input group-->
                    <div class="d-flex flex-column mb-8 fv-row">
                    ...
                    <div class="d-flex flex-column mb-8 fv-row">
                        ...
                        <!--end::Label-->
                        <input type="text" class="form-control form-control-solid" name="user[address][line2]"  value="{{old('user.address.line2')}}" />
                    </div>
                     <!--begin::Label-->
                              <label class="d-flex align-items-center fs-6 fw-bold mb-2" for="entity_group">
                            ...
                            <div class="d-flex flex-column mb-8 fv-row">
                                ...
                                <!--end::Label-->
                                <input type="email" class="form-control form-control-solid" required placeholder="{{__('messages.Email')}}" name="name[en]"  value="{{old('name.en')}}" />
                            </div>
                            <div class="d-flex flex-column mb-8 fv-row">
                                <!--begin::Label-->
                                <label class="d-flex align-items-center fs-6 fw-bold mb-2" >
