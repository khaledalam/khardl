                                                ...
                                                <!--end::Input group-->
                                                    ...
                                                    <div class="row g-9 mb-8">
                                                        ...
                                                        <div class="col-md-6 fv-row">
                                                            ...
                                                            <label class="d-flex align-items-center fs-6 fw-bold mb-2">
                                                                <input type="checkbox" name="allow_buy_with_loyalty_points" checked value="1">
                                                            </label>
                                                        </div>
                                                        <!--end::Col-->
                                                        <!--begin::Col-->
                                                        <div class="col-md-6 fv-row">
                                                            ...
                                                            <input type="number" step="0.1" min="0.1" required name="price_using_loyalty_points" value="{{ old('price_using_loyalty_points') ?? $item->price_using_loyalty_points }}" class="form-control form-control-solid ps-12" />
                                                        </div>
                                                        <!--end::Col-->
