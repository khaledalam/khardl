             ...
             <div id="kt_content_container" class="container-xxl">
                 ...
                 <div class="d-flex flex-column gap-7 gap-lg-10">
                     <div class="d-flex flex-wrap flex-stack gap-3 gap-lg-10">
                         ...
                         <a href="#" class="btn btn-light-success btn-sm" >Approved</a>
                         <a href="#" class="btn btn-light-danger btn-sm">Denied</a>    
                                         ...
                                         <div class="card card-xl-stretch">
                                             ...
                                             <div class="card-header align-items-center border-0 mt-4">
                                                 <h3 class="card-title align-items-start flex-column">
                                                     <span class="fw-bolder mb-2 text-dark">Preparations</span>
                                                 </h3>
                                             </div>
                                             <!--end::Header-->
                                             <!--begin::Body-->
