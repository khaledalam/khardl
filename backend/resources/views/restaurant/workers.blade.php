                                 ...
                                 <tbody>
                                    @foreach ($workers as $worker)
                                        ...
                                        @else
                                            <tr>
                                        @endif
                                            <td class="text-muted fw-bolder text-center">
                                                {{ $worker->id }}
                                            </td>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="d-flex justify-content-start flex-column">
                                                        <a class="text-dark fw-bolder text-hover-khardl fs-6">{{ $worker->first_name }}</a>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-end flex-shrink-0">
                                                    @if($user->id != $worker->id)
                                                        <a href="{{ route('restaurant.edit-worker', ['id' => $worker->id]) }}" class="btn btn-icon btn-bg-light btn-active-color-khardl btn-sm me-1">
                                                    ...
                                                    @if($user->isRestaurantOwner())
                                                        <form class="delete-form" action="{{ route('restaurant.delete-worker', ['id' => $worker->id]) }}" method="POST">
                                                            @method('DELETE')
                                                            @csrf
