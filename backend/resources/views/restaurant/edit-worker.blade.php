                    ...
                    <div class="d-flex flex-column gap-7 gap-lg-10">
                        ...
                        <!--begin::Card body-->
                            ...
                            <div class="mb-10 fv-row">
                                ...
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input type="tel" pattern="[0-9+]{10,14}" onkeypress="return event.charCode >= 48 && event.charCode <= 57 || event.charCode === 43" minlength="10" maxlength="14" class="form-control @error('phone_number') is-invalid @enderror" value="{{ $worker->phone_number }}" name="phone_number" id="phone_number" placeholder="05XXXXXXXX" required>
                                <!--end::Input-->
                                <!--begin::Description-->
                                                                ...
                                                                <div class="card-body border-top py-9 mx-0 px-0">
                                                                    ...
                                                                    <div class="row mb-0 mt-5">
                                                                        ...
                                                                        <div class="form-check form-check-solid form-switch fv-row">
                                                                          <input class="form-check-input w-35px h-20px" type="checkbox" id="can_modify_and_see_other_workers" @if (DB::table('permissions_worker')->where('user_id', $worker->id)->value('can_modify_and_see_other_workers') == 1) checked  @endif value="1" name="can_modify_and_see_other_workers">
                                                                            <label class="form-check-label" for="can_modify_and_see_other_workers">{{ __('messages.can-modify-working-time') }}</label>
                                                                        </div>
                                                                        <!--end::Label-->
                                                                    </div>
                                                                    <!--end::Input group-->
                                                                    ...
                                                                    <div class="row mb-0 mt-5">
                                                                        <!--begin::Label-->
                                                                        <div class="form-check form-check-solid form-switch fv-row">
                                                                          <input class="form-check-input w-35px h-20px" type="checkbox" id="can_modify_working_time" value="1" @if (DB::table('permissions_worker')->where('user_id', $worker->id)->value('can_modify_working_time') == 1) checked  @endif name="can_modify_working_time">
                                                                            <label class="form-check-label" for="can_modify_working_time">{{ __('messages.can-modify-and-see-other-workers') }}</label>
                                                                        </div>
                                                                        <!--end::Label-->
                                                                    </div>
                                                                    <!--end::Input group-->
