                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-md-6">
                                                                                <div class="mb-10 fv-row">
                                                                                    ...
                                                                                    <input type="number" min="1" name="max_use_per_user" value="{{ old('max_use_per_user') }}" class="form-control mb-2" placeholder="{{ __('Max use per user') }}" />
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-md-6">
                                                                                <div class="mb-10 fv-row">
                                                                                    ...
                                                                                    <input type="number" min="1" name="max_discount_amount"  value="{{ old('max_discount_amount') }}" class="form-control mb-2" placeholder="{{ __('Amount') }}" />
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-md-6">
                                                                                <div class="mb-10 fv-row">
                                                                                    ...
                                                                                    <input type="number" min="1" name="minimum_cart_amount" value="{{ old('minimum_cart_amount') }}" class="form-control mb-2" placeholder="{{ __('Cart total') }}" />
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-md-6">
                                                                                <div class="fv-row mt-5">
                                                                                    ...
                                                                                    <input type="date" name="active_from" class="form-control mb-2" value="{{ old('active_from') }}"/>
                                                                                </div>
                                                                            <!--end::Col 2-->
                                                                        </div>
                                                                        <div class="col-md-6">
                                                                            <div class="fv-row mt-5">
                                                                                ...
                                                                                <input type="date" name="expire_at" class="form-control mb-2"  value="{{ old('expire_at') }}"/>
                                                                            </div>
                                                                        </div>
