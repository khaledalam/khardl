...
<table style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <!--[if mso]><table width="100%"><tr><td><![endif]-->
    <h1 style="margin: 0px; line-height: 140%; text-align: center; word-wrap: break-word; font-family: 'Cabin',sans-serif; font-size: 22px; font-weight: 400;"><span><strong>{{ __('Dear :user', ['user', $user->first_name]) }}</strong></span></h1>
...
<table style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <!--[if mso]><table width="100%"><tr><td><![endif]-->
    <h4 style="margin: 0px; line-height: 140%; text-align: center; word-wrap: break-word; font-family: 'Cabin',sans-serif; font-size: 16px; font-weight: 400;"><p style="line-height: 140%;">{{ __('We are delighted to inform you that your business request with reference :business_id has been successfully approved! We appreciate your partnership and look forward to continuing our collaboration.',['business_id' => $business->business_id]) }}</p></h4>
  <!--[if mso]></td></tr></table><![endif]-->
...
<table style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <!--[if mso]><table width="100%"><tr><td><![endif]-->
    <h4 style="margin: 0px; line-height: 140%; text-align: center; word-wrap: break-word; font-family: 'Cabin',sans-serif; font-size: 16px; font-weight: 400;"><span><span><span><span><span><span><span><span><span><span>{{ __('To proceed with the next steps, we invite you to purchase your new subscription by following this URL') }} <a rel="noopener" href="{{$subscription_url}}" target="_blank">( --- )</a>. {{ __('Our team is ready to assist you throughout the process and answer any questions you may have.') }}</span></span></span></span></span></span></span></span></span></span></h4>
  <!--[if mso]></td></tr></table><![endif]-->
...
<table style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <!--[if mso]><table width="100%"><tr><td><![endif]-->
    <h4 style="margin: 0px; line-height: 140%; text-align: center; word-wrap: break-word; font-family: 'Cabin',sans-serif; font-size: 16px; font-weight: 400;"><span><span><span><span>{{ __('Thank you for choosing our services. We value your business and are committed to providing you with the best experience.') }}</span></span></span></span></h4>
  <!--[if mso]></td></tr></table><![endif]-->
