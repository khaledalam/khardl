...
<table style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <!--[if mso]><table width="100%"><tr><td><![endif]-->
    <h1 style="margin: 0px; line-height: 140%; text-align: center; word-wrap: break-word; font-family: 'Cabin',sans-serif; font-size: 22px; font-weight: 400;"><span><span><span><span><span><strong>{{ __('Mobile App Completed') }}</strong></span></span></span></span></span></h1>
...
<table style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <!--[if mso]><table width="100%"><tr><td><![endif]-->
    <h4 style="margin: 0px; line-height: 160%; text-align: center; word-wrap: break-word; font-family: 'Cabin',sans-serif; font-size: 16px; font-weight: 400;"><span><span><span>{{ __('Your new mobile app has been successfully added to your restaurant, you can access it by going to the services page.') }}</span></span></span></h4>
  <!--[if mso]></td></tr></table><![endif]-->
