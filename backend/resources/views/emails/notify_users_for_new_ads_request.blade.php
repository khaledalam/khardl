...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office" @if(app()->getLocale() === 'ar') dir="rtl" style="direction: rtl" @endif lang="{{ app()->getLocale() }}">
<head>
    <!--[if gte mso 9]>
<xml>
                            ...
                            <div style="border-collapse: collapse;display: table;width: 100%;height: 100%;background-color: transparent;">
                                ...
                                <div class="u-col u-col-100" style="max-width: 320px;min-width: 500px;display: table-cell;vertical-align: top;">
                                    <div style="background-color: #ffffff;height: 100%;width: 100% !important;border-radius: 0px;-webkit-border-radius: 0px; -moz-border-radius: 0px;">
                                        <!--[if (!mso)&(!IE)]><!-->
                                        <div style="box-sizing: border-box; height: 100%; padding: 0px;border-top: 5px solid #c2da0a;border-left: 0px solid transparent;border-right: 0px solid transparent;border-bottom: 0px solid transparent;border-radius: 0px;-webkit-border-radius: 0px; -moz-border-radius: 0px;">
                                            <!--<![endif]-->
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:10px 10px 2px;font-family:arial,helvetica,sans-serif;" align="left">
                                                            ...
                                                            <h1 style="margin: 0px; line-height: 140%; text-align: center; word-wrap: break-word; font-family: 'Cabin',sans-serif; font-size: 22px; font-weight: 400;"><span><span><span><span><strong>{{ __('An advertising service has been requested from a restaurant')}}</strong></span></span></span></span></h1>
                                                    ...
                                                    <tr>
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:arial,helvetica,sans-serif;" align="left">
                                                            ...
                                                            <div style="font-family: 'Cabin',sans-serif; font-size: 9px; line-height: 140%; text-align: center; word-wrap: break-word;">
                                                                <h1><strong>{{ __('Dear: :user_name', ['user_name' => $user_name])}}</strong></h1>
                                                            </div>
                                                    ...
                                                    <tr>
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:arial,helvetica,sans-serif;" align="left">
                                                            ...
                                                            <h4 style="margin: 0px; line-height: 160%; text-align: center; word-wrap: break-word; font-family: 'Cabin',sans-serif; font-size: 16px; font-weight: 400;">
                                                                <p style="color: #000000; text-align: -webkit-center; white-space: normal; background-color: #ffffff; line-height: 160%;">
                                                                    {{ __('We wanted to inform you that an advertising service has been requested from :restaurant_name restaurant, on the :package_name. The advertising service was requested for :price riyals. Please review the order',
                                                                    ['restaurant_name' => $restaurant_name, 'package_name' => $package_name, 'price' => $price])}}.</p>
                                                            </h4>
                                                            <!--[if mso]></td></tr></table><![endif]-->
