   ...
   /**
    ...
    public function rules()
    {
        return [
            ...
            'contact_person.contact_info.primary.phone' => 'nullable|array',
            'contact_person.contact_info.primary.phone.country_code' => 'nullable|string',
            'contact_person.contact_info.primary.phone.number' => 'nullable|string',
