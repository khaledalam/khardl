        ...
        Route::middleware('verified')->group(function () {
            ...
            Route::middleware(['accepted'])->group(function () {
                ...
                Route::prefix('admin')->middleware('admin')->group(function () {
                    ...
                    Route::put('/restaurants/{restaurant}/activate', [AdminController::class, 'activateRestaurant'])->middleware('permission:can_update_restaurant_settings')->name('admin.restaurant.activate');
